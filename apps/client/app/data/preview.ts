...
export const previewCase: PortalCase = {
  ...
  documents: {
    ...
    items: [
      {
        id: 'preview-requirement-bank-statements',
        name: 'Wyciąg z rachunku za ostatnie 3 miesiące',
      ...
      {
        id: 'preview-requirement-employment',
        name: 'Zaświadczenie o zatrudnieniu i dochodach',
      ...
      {
        id: 'preview-requirement-tax',
        name: 'PIT za poprzedni rok',
      ...
      {
        id: 'preview-upload-preliminary-agreement',
        name: 'Umowa przedwstępna.pdf',
        documentType: 'preliminary_agreement',
        status: 'verified',
        receivedAt: '2026-07-29T11:08:00.000Z',
        verifiedAt: '2026-07-30T13:42:00.000Z',
        updatedAt: '2026-07-30T13:42:00.000Z',
        canDownload: true,
      },
      {
        id: 'preview-upload-income',
        name: 'Zaświadczenie o zarobkach.pdf',
        documentType: 'income_confirmation',
        status: 'received',
        receivedAt: '2026-07-30T12:21:00.000Z',
        updatedAt: '2026-07-30T12:21:00.000Z',
        canDownload: true,
      },
    ],
  },
...
export const previewWaitingCase: PortalCase = {
  ...
  documents: {
    ...
    items: [
      {
        id: 'preview-refinance-agreement',
        name: 'Umowa kredytowa.pdf',
        documentType: 'credit_agreement',
        status: 'verified',
        receivedAt: '2026-05-13T08:30:00.000Z',
        verifiedAt: '2026-05-14T09:10:00.000Z',
        updatedAt: '2026-05-14T09:10:00.000Z',
        canDownload: true,
      },
      {
        id: 'preview-refinance-schedule',
        name: 'Harmonogram spłat.pdf',
        documentType: 'repayment_schedule',
        status: 'verified',
        receivedAt: '2026-05-13T08:32:00.000Z',
        verifiedAt: '2026-05-14T09:12:00.000Z',
        updatedAt: '2026-05-14T09:12:00.000Z',
        canDownload: true,
      },
      {
        id: 'preview-refinance-balance',
        name: 'Zaświadczenie o saldzie.pdf',
        documentType: 'loan_balance',
        status: 'verified',
        receivedAt: '2026-05-15T10:05:00.000Z',
        verifiedAt: '2026-05-16T11:20:00.000Z',
        updatedAt: '2026-05-16T11:20:00.000Z',
        canDownload: true,
      },
      {
        id: 'preview-refinance-property',
        name: 'Operat szacunkowy.pdf',
        documentType: 'appraisal',
        status: 'received',
        receivedAt: '2026-07-28T14:40:00.000Z',
...
export const previewPortal: PortalPayload = {
  ...
  nextStep: {
    ...
    to: `/preview/cases/${previewCase.id}?view=documents`,
  },
}
