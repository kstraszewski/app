...
// Reflection canvases are soft, transient light. A Retina-sized canvas above
// this budget adds memory and raster cost without improving the visible edge.
export const REFLECTION_MAX_DEVICE_PIXELS = 512 * 512;
