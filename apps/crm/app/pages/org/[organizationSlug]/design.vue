...
useHead({ title: 'Design — OpenExpert CRM' })
...
<template>
  <CrmShell title="Design system" eyebrow="Administracja organizacji">
    <template #actions>
      <UBadge v-if="isDirty" color="warning" variant="subtle" icon="i-lucide-circle-dot">
        Niezapisane zmiany
      </UBadge>
      <UButton
        color="neutral"
    ...
    <UAlert
      v-if="response && !response.canEdit"
    ...
    <div class="design-editor">
        ...
        <div class="design-editor__panel">
          <section v-if="activeSection === 'brand'" class="editor-section">
            <div class="editor-section__head">
              <p>Marka</p>
              <h2>Logo i identyfikacja</h2>
              <span>Ustawienia nazw i assetów używanych na jasnych oraz ciemnych powierzchniach.</span>
            </div>
      ...
      <section class="design-preview" aria-label="Podgląd design systemu">
        <div class="design-preview__head">
          <div>
            <p>Podgląd na żywo</p>
            <h2>Zmiany obejmują całą aplikację</h2>
          </div>
          <UColorModeSelect aria-label="Motyw podglądu" />
        </div>
        ...
        <div class="preview-dashboard">
          ...
          <main>
            <div class="preview-toolbar">
              ...
              <UButton color="neutral" variant="solid" icon="i-lucide-plus">Dodaj klienta</UButton>
            </div>
            <div class="preview-metrics">
              <UCard>
                <span>Aktywni klienci</span>
                <strong>128</strong>
                <UBadge color="success" variant="subtle">+12%</UBadge>
              </UCard>
              <UCard>
                <span>Sprawy w toku</span>
                <strong>34</strong>
                <UBadge color="warning" variant="subtle">8 pilnych</UBadge>
              </UCard>
            </div>
            <UCard>
              <template #header>
                <div class="preview-card-head">
                  <div>
                    <strong>Nowa sprawa</strong>
                    <span>Komponenty korzystają z aktywnych tokenów.</span>
                  </div>
                  <UBadge color="info" variant="subtle">Podgląd</UBadge>
                </div>
              </template>
              <div class="preview-form">
                <UFormField label="Klient">
                  <UInput placeholder="Anna Kowalska" icon="i-lucide-user" />
                </UFormField>
                <UFormField label="Produkt">
                  <USelect :items="['Kredyt hipoteczny', 'Ubezpieczenie', 'Inwestycja']" placeholder="Wybierz produkt" />
                </UFormField>
              </div>
            </UCard>
          </main>
