...
// Reflection canvases are injected into the target. Keep interactive HTML
// controls out of this API so their content model and focus semantics remain
// intact; consumers can wrap a control in a visible, non-interactive surface.
...
export interface ReflectionTarget {
  ...
  previousInlineIsolation: string;
