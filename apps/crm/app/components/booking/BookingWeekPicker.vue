...
<template>
  <section class="booking-week" aria-labelledby="booking-slot-title">
      ...
      <div class="booking-week__heading">
        ...
        <div class="booking-week__navigation" aria-label="Nawigacja po tygodniach">
          ...
          <span class="booking-week__range">
            ...
            <h2 id="booking-slot-title">{{ rangeLabel }}</h2>
          </span>
          <UButton
            type="button"
            color="neutral"
    ...
    <div v-if="pending" class="booking-week__loading" aria-label="Ładowanie dostępnych terminów">
    ...
    <template v-else>
      ...
      <div class="booking-week__mobile">
        ...
        <div v-else class="booking-week__mobile-empty">
          <UIcon name="i-lucide-calendar-x-2" aria-hidden="true" />
          <p>Brak wolnych terminów tego dnia.</p>
          <small>Wybierz inny dzień z paska powyżej.</small>
        </div>
      </div>
    </template>
    ...
    <p class="booking-week__trust">
      <UIcon name="i-lucide-shield-check" aria-hidden="true" />
      Rezerwacja bezpłatna · potwierdzenie od razu
    </p>
  </section>
</template>
